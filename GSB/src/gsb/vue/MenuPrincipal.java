...
public class MenuPrincipal extends JFrame implements ActionListener {
	...
	public MenuPrincipal() {
		...
		mStoctOffr = new JMenu("Stock/Offrir");
		JMenuItem mO1 = new JMenuItem("Offrir");
		mO1.addActionListener(this); // installation d'un écouteur d'action
		mStoctOffr.add(mO1);
		JMenuItem mO2 = new JMenuItem("Stocker");
	...
	public void actionPerformed(ActionEvent evt) {
		...
		if (evt.getSource() instanceof JMenuItem) {
			...
			else if (ChoixOption.equals("Stocker")) {
				ouvrirFenetre(new JIFStock(this));
			}
			else if (ChoixOption.equals("Offrir")) {
				ouvrirFenetre(new JIFOffrir(this));
			}
		}
	...
	public void ouvrirFenetre(JInternalFrame uneFenetre) {
		...
		myJInternalFrame.setSize(800, 600);
